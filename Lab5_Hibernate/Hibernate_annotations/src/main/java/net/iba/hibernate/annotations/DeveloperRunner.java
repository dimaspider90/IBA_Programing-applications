...
public class DeveloperRunner {
    ...
    public static void main(String[] args) {
        // Инициализация Configuration и добавление аннотированного класса
        Configuration configuration = new Configuration();
        configuration.configure("hibernate.cfg.xml"); // Загрузка настроек из hibernate.cfg.xml
        configuration.addAnnotatedClass(Developer.class); // Регистрация аннотированного класса Developer
