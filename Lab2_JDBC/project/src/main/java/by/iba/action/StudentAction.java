...
public class StudentAction {
    ...
    public void fetchByEmailId(String mailId) {
        Student student = dao.fetchByEmailId(mailId);
        if (student.getId() == 0) {
            System.out.println("No Record Found");
        } else {
            System.out.println("Student Details are :");
    ...
    public void fetchByName(String fname) {
        List<Student> studentList = dao.fetchByName(fname);
